      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="profile" className="w-full">
          <TabsList className="bg-card border border-border mb-6">
            <TabsTrigger value="profile" className="data-[state=active]:bg-gold data-[state=active]:text-pitch">
              <User className="w-4 h-4 mr-2" />
              Profile
            </TabsTrigger>
            <TabsTrigger value="notifications" className="data-[state=active]:bg-gold data-[state=active]:text-pitch">
              <Bell className="w-4 h-4 mr-2" />
              Notifications
            </TabsTrigger>
            <TabsTrigger value="security" className="data-[state=active]:bg-gold data-[state=active]:text-pitch">
              <Shield className="w-4 h-4 mr-2" />
              Security
            </TabsTrigger>
            <TabsTrigger value="appearance" className="data-[state=active]:bg-gold data-[state=active]:text-pitch">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <Badge
                          ...
                          className={member.is_active ? 'bg-emerald-500/20 text-emerald-500' : ''}
                        >
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-foreground">New Sales Notifications</p>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-foreground">Daily Report Summary</p>
                      <p className="text-sm text-muted-foreground">
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-3 gap-4">
                  <button
                    className="p-4 rounded-lg border-2 border-border bg-secondary/50 hover:border-gold/30 transition-colors text-center"
                  >
                  ...
                  <button
                    className="p-4 rounded-lg border-2 border-border bg-secondary/50 hover:border-gold/30 transition-colors text-center opacity-50 cursor-not-allowed"
                  >
